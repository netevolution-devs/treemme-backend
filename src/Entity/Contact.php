...
class Contact
{
    ...
    #[Groups(['contact_list','contact_detail','contact_type_detail', 'leather_list',
        ...
        'color_list', 'color_detail', 'batch_data_detail', 'client_order_row_list', 'client_summary_print', 'client_order_row_list', 'production_list'])]
    private ?int $id = null;
    ...
    #[Groups(['contact_list','contact_detail','contact_type_detail','leather_list',
        ...
        'client_order_row_list', 'client_summary_print', 'client_order_row_list', 'production_list'])]
