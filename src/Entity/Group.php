...
class Group
{
    ...
    #[Groups(['group_list','group_detail', 'user_list', 'user_detail', 'group_role_work_area_list', 'group_role_work_area_detail'])]
    ...
    #[Groups(['group_list','group_detail', 'group_role_work_area_list', 'group_role_work_area_detail'])]
