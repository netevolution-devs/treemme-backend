...
class ClientOrder
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['client_order_list', 'client_order_detail', 'client_detail', 'client_summary_print', 'production_list'])]
    private ?int $id = null;
    ...
    #[Groups(['client_order_list', 'client_order_detail', 'client_summary_print', 'client_order_row_list', 'production_list'])]
