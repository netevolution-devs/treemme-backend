 ...
 *         proxy_dir?: scalar|null|Param, // Default: "%kernel.cache_dir%/doctrine/orm/Proxies"
 ...
 *     private_key_path?: scalar|null|Param, // Deprecated: The "lexik_jwt_authentication.private_key_path.private_key_path" configuration key is deprecated since version 2.5. Use "lexik_jwt_authentication.private_key_path.secret_key" instead. // Default: null
 *     public_key_path?: scalar|null|Param, // Deprecated: The "lexik_jwt_authentication.public_key_path.public_key_path" configuration key is deprecated since version 2.5. Use "lexik_jwt_authentication.public_key_path.public_key" instead. // Default: null
 ...
 *     },
 *     user_identity_field?: scalar|null|Param, // Deprecated: The "lexik_jwt_authentication.user_identity_field.user_identity_field" configuration key is deprecated since version 2.16, use "lexik_jwt_authentication.user_identity_field.user_id_claim" or implement "Symfony\Component\Security\Core\User\UserInterface::getUserIdentifier()" instead. // Default: "username"
 *     user_id_claim?: scalar|null|Param, // If null, the user ID claim will have the same name as the one defined by the option "user_identity_field" // Default: null
 ...
 *     },
 *     areas?: array<string, array{ // Default: {"default":{"path_patterns":[],"host_patterns":[],"with_annotation":false,"documentation":[],"name_patterns":[],"disable_default_routes":false,"cache":[]}}
 *         path_patterns?: list<scalar|null|Param>,
 *         host_patterns?: list<scalar|null|Param>,
 *         name_patterns?: list<scalar|null|Param>,
 *         with_annotation?: bool|Param, // whether to filter by annotation // Default: false
